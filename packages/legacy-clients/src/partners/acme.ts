...
const BASE_URL = "https://api.acme.example/v2";

export async function fetchAcmeExpenses(since: any): Promise<PartnerExpense[]> {
...
export function acmeCutoff(days: number) {
