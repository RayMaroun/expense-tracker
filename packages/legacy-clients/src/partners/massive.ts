...
const BASE_URL = "https://api.massive.example/v2";

export async function fetchMassiveExpenses(since: any): Promise<PartnerExpense[]> {
...
export function massiveCutoff(days: number) {
